        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <p className="pt-2">
                <a href={`tel:${companyInfo.phone}`} className="hover:text-primary-400">
                  📞 {companyInfo.phone}
                </a>
              </p>
              <p>
                <a href={companyInfo.social.whatsapp} target="_blank" rel="noopener noreferrer" className="hover:text-primary-400">
